...
"x86_64-linux-thread-multi-6.8.0-47-generic" or
	die "Errno architecture (x86_64-linux-thread-multi-6.8.0-47-generic) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
