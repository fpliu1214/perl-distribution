...
tie %Config, 'Config', {
    archlibexp => relocate_inc('.../../lib/5.38.2/x86_64-linux-thread-multi'),
    ...
    osname => 'linux',
    osvers => '6.8.0-47-generic',
    path_sep => ':',
    privlibexp => relocate_inc('.../../lib/5.38.2'),
    scriptdir => '.../',
    sitearchexp => relocate_inc('.../../lib/site_perl/5.38.2/x86_64-linux-thread-multi'),
    sitelibexp => relocate_inc('.../../lib/site_perl/5.38.2'),
    so => 'so',
    useithreads => 'define',
